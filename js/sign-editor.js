        ...
        this._fields.forEach((field, index) => {
            ...
            if (this._inlinePreviewMode) {
                ...
                div.innerHTML = field.type === 'signature'
                    ...
                    <span style="position:absolute; top:-20px; left:-50px; z-index:2; background:#111827; color:#fff; font-size:11px; font-weight:700; min-width:42px; height:28px; padding:0 10px; border-radius:999px; white-space:nowrap; display:inline-flex; align-items:center; justify-content:center; box-shadow:0 6px 14px rgba(15,23,42,0.18);">${sequenceLabel}</span>

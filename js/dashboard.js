                ...
                <header class="analysis-v3-header">
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <div style="display:flex; gap:8px;">
                            <button class="v3-btn-outline" onclick="window.app.downloadOriginalFile(${contract.id})"><i class="fa-solid fa-file-word"></i> 原本Word</button>
                            <button class="v3-btn-outline" onclick="window.print()"><i class="fa-solid fa-file-pdf"></i> PDF出力</button>
                            <button class="v3-btn-outline"><i class="fa-regular fa-note-sticky"></i> メモ</button>
                            <button class="v3-btn-primary" onclick="window.app.showRegistrationModal({contractId: ${contract.id}, step: 2})"><i class="fa-solid fa-cloud-arrow-up"></i> 新しいバージョン</button>
                        </div>
                    </div>
                </header>
                ...
                <div class="ds-steps-container">
                    ...
                    <div class="ds-step-item active" id="s-step-1">
                        ...
                        <div class="ds-step-info">
                            ...
                            <div class="ds-step-status" id="s-status-1">完了</div>
                        </div>
                    </div>
                        ...
                        <div class="ds-summary-section">
                            ...
                            <div class="ds-summary-grid">
                                ...
                                <div class="ds-summary-card">
                                    ...
                                    <div class="ds-card-info">
                                        <div>要約</div>
                                        <div><span>${summaryLen}文字</span>で要約完了</div>
                                    </div>
                                </div>
                                <div class="ds-summary-card">
                                    ...
                                    <div class="ds-card-info">
                                        <div>修正案</div>
                                        <div><span>${suggestCount}件</span>の修正案を作成</div>
                                    </div>
                                </div>
                                <div class="ds-summary-card">
...
class DashboardApp {
    ...
    async downloadOriginalFile(contractId) {
        ...
        const contract = dbService.getContractById(targetId);
        if (!contract) {
        ...
        const downloadUrl = resolveBackendAssetUrl(originalPath);
    ...
    async startAnalysis() {
        Notify.info('解析を開始します...');
        this.isAnalyzing = true;
        this.navigate('diff-check');
        await new Promise(resolve => setTimeout(resolve, 800));
        this.isAnalyzing = false;
        this.isAnalyzed = true;
        Notify.success('差分チェックが完了しました');
        this.navigate('diff-check');
    }

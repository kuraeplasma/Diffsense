                ...
                <div class="detail-split-body">
                    ...
                    <div class="pane">
                        <div class="pane-header">
                            ...
                            <span class="text-muted" style="font-weight:normal; font-size:11px;">最終解析: 2026.01.29</span>
                        </div>
                        <div class="pane-scroll-area">
                            ...
                            <div class="analysis-section-title">
                                <i class="fa-solid fa-comment-dots"></i> 社内メモ・監査記録
                            </div>
                            <div style="padding-bottom:40px;">
                                <textarea id="memo-input" style="width:100%; border:1px solid #ddd; padding:12px; border-radius:4px; font-family:inherit; min-height:80px;" placeholder="確認事項や法務部への相談内容を入力..."></textarea>
                                <div class="flex justify-between items-center mt-md">
                                    <button class="btn-dashboard" onclick="window.app.addMemo(${id})">メモを保存</button>
                                    <div class="text-muted" style="font-size:11px;">判断記録を残すことで、DIFFsenseの価値が完成します。</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pane">
                        <div class="pane-header">
                            ...
                            <div class="flex gap-sm">
                                <button class="btn-dashboard" style="padding:2px 8px; font-size:11px; height:auto;" onclick="alert('印刷機能は開発中です')"><i class="fa-solid fa-print"></i> 印刷</button>
                                <button class="btn-dashboard" style="padding:2px 8px; font-size:11px; height:auto;" onclick="alert('拡大機能は開発中です')"><i class="fa-solid fa-magnifying-glass-plus"></i> 拡大</button>
                            </div>
                        </div>
                        <div class="pane-scroll-area document-pane-bg">
                            <div class="document-paper">
                                <div class="document-content">
                                    ${contract.original_content || '原本データがありません'}
                                </div>
                            </div>
                        </div>
                    </div>
